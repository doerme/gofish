...
<style>
    ...
    .dialog-caishen .shine-bg{
        ...
        width:100%;
        height:1050px;
        background-image:url('http://zjshop.tcpan.com/mex/caishen/caishen-shine.png');
    ...
    .dialog-caishen .caishen-bg{
        ...
        width:750px;
        height:950px;
        background-image:url('http://zjshop.tcpan.com/mex/caishen/caishen.png');
        background-size:750px;
        background-repeat:no-repeat;
        background-position:top center;
    }
    ...
    .dialog-caishen .box-move span{
        ...
        width:225px;
        height:187px;
        background-image:url('http://zjshop.tcpan.com/mex/caishen/caishen-box.png');
    ...
    .dialog-caishen .box-move span.step1{
        ...
        margin-top:-89px;
        margin-left:-155px;
        background-image:url('http://zjshop.tcpan.com/mex/caishen/box-open-1.png');
    ...
    .dialog-caishen .box-move span.step2{
        ...
        margin-top:-89px;
        margin-left:-155px;
        background-image:url('http://zjshop.tcpan.com/mex/caishen/box-open-2.png');
        background-size:510px;
    }
    .dialog-caishen .box-move span.step3{
        ...
        margin-top:-89px;
        margin-left:-155px;
        background-image:url('http://zjshop.tcpan.com/mex/caishen/box-open-3.png');
        background-size:510px;
    }
    .dialog-caishen .box-lotteryed{
        ...
        width:750px;
        height:599px;
        background-image:url('http://zjshop.tcpan.com/mex/caishen/box-quan.png');
        background-size:750px;
        background-repeat:none;
        background-position: bottom center;
    }
    .dialog-caishen .quan-lotteryed{
        ...
        height:190px;
        margin:210px auto 0;
        background-image: url('http://zjshop.tcpan.com/mex/caishen/quan-bg.png');
