...
<script>
    ...
    const ajaxHost = `//zjshop.tcpan.com/`;
        ...
        methods: {
            allImgLoaded() {
                ...
                var allNeededImgArray = [
                    'http://zjshop.tcpan.com/mex/fish/img/baoxiang.png',
                    'http://zjshop.tcpan.com/mex/fish/img/chugan.png',
                    'http://zjshop.tcpan.com/mex/fish/img/num-6.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-2-2.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-6-2.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-8-3.png',
                    'http://zjshop.tcpan.com/mex/fish/img/bg-2.png',
                    'http://zjshop.tcpan.com/mex/fish/img/dialog-box.png',
                    'http://zjshop.tcpan.com/mex/fish/img/num-8.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-3.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-6-3.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-8.png',
                    'http://zjshop.tcpan.com/mex/fish/img/bg.png',
                    'http://zjshop.tcpan.com/mex/fish/img/guanxian-1.png',
                    'http://zjshop.tcpan.com/mex/fish/img/num-9.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-4-2.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-6.png',
                    'http://zjshop.tcpan.com/mex/fish/img/bizhikuang.png',
                    'http://zjshop.tcpan.com/mex/fish/img/loading-bg.png',
                    'http://zjshop.tcpan.com/mex/fish/img/rule-butn.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-4.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-7-2.png',
                    'http://zjshop.tcpan.com/mex/fish/img/butn-rule-home.png',
                    'http://zjshop.tcpan.com/mex/fish/img/muban.png',
                    'http://zjshop.tcpan.com/mex/fish/img/rule.jpg',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-5-2.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-7-3.png',
                    'http://zjshop.tcpan.com/mex/fish/img/butn-tuoguan.png',
                    'http://zjshop.tcpan.com/mex/fish/img/num-0.png',
                    'http://zjshop.tcpan.com/mex/fish/img/tuoguan.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-5-3.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-7.png',
                    'http://zjshop.tcpan.com/mex/fish/img/chugan-bg.png',
                    'http://zjshop.tcpan.com/mex/fish/img/num-3.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-1-2.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-5.png',
                    'http://zjshop.tcpan.com/mex/fish/img/yu-8-2.png'
                ];
                ...
                for (var i = 0; i < allNeededImgArray.length; i++) {
                    ...
                    _img.onload = function() {
                        currentLoadedImg += 1;
                        $('.loading-bg p').velocity('stop').velocity({
            ...
            ajaxGetUserInfo() { //用户信息接口
                var self = this;
                $.ajax({
                    url: ajaxHost + "/app/fishing/user", ///api/hldy/dy/index
                    dataType: "json",
                    type: 'GET',
            ...
            ajaxLottery(callback) { //钓鱼接口
                var self = this;
                $.ajax({
                    url: ajaxHost + "/app/fishing/doFish", ///api/hldy/dy/doFish /api/hldy/dy/configHitNumRate
                    dataType: "json",
                    type: 'POST',
                    data: {
